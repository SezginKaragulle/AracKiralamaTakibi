...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <table align="center" cellpadding="2" class="auto-style1">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="drpVehiclePlate" runat="server" Width="162px" CssClass="css-input">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCustomerCode" runat="server" Width="162px" CssClass="css-input" onkeypress ="KeyPressed(event)"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:TextBox ID="txtEmail" runat="server" Width="162px" CssClass="css-input"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style3">
        ...
        <tr>
            <td>
                <asp:Button ID="btnContractAdded" runat="server" Text="Ekle" Width = "125px" CssClass="myButton"/>
            </td>
            <td>
